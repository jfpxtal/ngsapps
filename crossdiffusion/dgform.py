...
class DGFormulation(Formulation):
    ...
    def BilinearForm(self, p, velocities):
        ...
        self.a += SymbolicBFI(p.Dr*p.eta / h * (r - r.Other()) * (tr - tr.Other()), skeleton=True)
        ...
        self.a += SymbolicBFI(-p.Dr*2*wb*p.eta / h * (r - r.Other()) * (tr - tr.Other()), skeleton=True)
        ...
        self.a += SymbolicBFI(p.Dr*2*wr*p.eta / h * (b - b.Other()) * (tr - tr.Other()), skeleton=True)
        ...
        self.a += SymbolicBFI(p.Db*p.eta / h * (b - b.Other()) * (tb - tb.Other()), skeleton=True)
        ...
        self.a += SymbolicBFI(-p.Db*2*wr*p.eta / h * (b - b.Other()) * (tb - tb.Other()), skeleton=True)
        ...
        self.a += SymbolicBFI(p.Db*2*wb*p.eta / h * (r - r.Other()) * (tb - tb.Other()), skeleton=True)
        ...
        # equation for r
        self.a += SymbolicBFI(-r*velor*grad(tr))
        self.a += SymbolicBFI(velor*n*0.5*(r + r.Other())*(tr - tr.Other()), skeleton=True)
        self.a += SymbolicBFI(0.5*abs(velor*n) * (r - r.Other())*(tr - tr.Other()), skeleton=True)

        # equation for b
        self.a += SymbolicBFI(-b*velob*grad(tb))
        self.a += SymbolicBFI(velob*n*0.5*(b + b.Other())*(tb - tb.Other()), skeleton=True)
        self.a += SymbolicBFI(0.5*abs(velob*n) * (b - b.Other())*(tb - tb.Other()), skeleton=True)
